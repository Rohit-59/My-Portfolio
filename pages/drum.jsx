    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <h2>Overview</h2>
          <p>
            This app was built using simple HTML, CSS and Javascript.It is another one of my fun projects which can be used if you want to play a drumkit using a website.
          </p>
          <a
            href='https://github.com/rohit-59/Drum-Kit'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://glittery-sunburst-f57776.netlify.app/'
            target='_blank'
            rel='noreferrer'
          >
        ...
        <div className='col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl py-4'>
          <div className='p-5'>
            ...
            <div className='grid grid-cols-3 md:grid-cols-1'>
              ...
              <p className='text-gray-600 py-2 flex items-center'>
                <RiRadioButtonFill className='pr-2' /> GitHub
              </p>
